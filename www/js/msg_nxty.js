...
const CU_CLOUD_INFO_TOGGLE_MODE_BIT    = 0x00000100;   // bit 8:  Simulates a 5 second button press to toggle Engr/Normal Mode
const CU_CLOUD_INFO_GET_PAGE_BIT       = 0x00000200;   // bit 9
const CU_CLOUD_INFO_LABEL_BIT          = 0x00000800;   // bit 11

// NU Cloud Info bits....................................
const NU_CLOUD_INFO_CMD_MASK          = 0x0000000F;
                ...
                if( nxtyCurrentReq == NXTY_SUPER_MSG_INFO_TYPE )
                {
                    ...
                    else
                    {
                            ...
                            
                        {
                            ...
                            if( myModel == null )
                            {
                                myModel = "MN" + (nxtyRxStatusBoardConfig | 0x01);
                            }
                            
                            if( nxtyRxStatusBoardConfig & IM_A_CU_MASK )
                            {
                                PrintLog(1,  "  Connected to CU: Board Config=" + nxtyRxStatusBoardConfig + " myModel=" + myModel);
                            }
                            else if( nxtyRxStatusBoardConfig & IM_A_1BOX_NU_MASK )
                            {
                                PrintLog(1,  "  Connected to 1BOX NU: Board Config=" + nxtyRxStatusBoardConfig + " myModel=" + myModel);
                            }
                            else
                            {
                                PrintLog(1,  "  Connected to NU: Board Config=" + nxtyRxStatusBoardConfig + " myModel=" + myModel);
                            }
                            ...
                            else
                            {
                               ...
                               PrintLog(1,  "  RegLock=0x" + U8ToHexText(nxtyRxRegLockStatus) + " (" + rLock + ")");               
                            }
...
{ 
    ...
    if( u32Addr == nxtyCuCloudBuffAddr )
    {
...
{ 
    ...
    PrintLog(1,  "Super Msg Send: Reset Ares" );
